...
{
    public partial class SeedIniData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Italy", "2019", "", "Red Wine", 20.00m, 0, "", 2, "Red" });

            migrationBuilder.InsertData(
                table: "Wines",
                columns: new[] { "Id", "Country", "CreatedOn", "ImageUrl", "Name", "Price", "Quantity", "Region", "SupplierId", "Type" },
                values: new object[] { 2, "Italy", "2020", "", "White Wine", 18.50m, 0, "", 1, "White" });

            migrationBuilder.InsertData(
                table: "Wines",
                columns: new[] { "Id", "Country", "CreatedOn", "ImageUrl", "Name", "Price", "Quantity", "Region", "SupplierId", "Type" },
                values: new object[] { 3, "Italy", "2018", "", "Rosé Wine", 15.75m, 0, "", 1, "Rosé" });

            migrationBuilder.InsertData(
                table: "Sales",
                columns: new[] { "Id", "CustomerId", "Quantity", "ReportId", "SaleDate", "SupplierId", "TotalPrice", "WineId" },
                values: new object[] { 1, 1, 2, 0, new DateTime(2024, 3, 29, 10, 31, 40, 937, DateTimeKind.Local).AddTicks(2068), 1, 40.00m, 1 });

            migrationBuilder.InsertData(
                table: "Sales",
                columns: new[] { "Id", "CustomerId", "Quantity", "ReportId", "SaleDate", "SupplierId", "TotalPrice", "WineId" },
                values: new object[] { 2, 2, 1, 0, new DateTime(2024, 3, 29, 10, 31, 40, 937, DateTimeKind.Local).AddTicks(2127), 2, 18.50m, 2 });
        }
