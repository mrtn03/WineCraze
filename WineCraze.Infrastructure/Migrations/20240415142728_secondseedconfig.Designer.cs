...
namespace WineCraze.Infrastructure.Migrations
{
    ...
    [Migration("20240415142728_secondseedconfig")]
    partial class secondseedconfig
    {
            ...
            modelBuilder.Entity("WineCraze.Infrastructure.Data.Models.Sale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            Quantity = 5,
                            SaleDate = new DateTime(2024, 4, 15, 17, 27, 27, 659, DateTimeKind.Local).AddTicks(3856),
                            SupplierId = 0,
                            TotalPrice = 44.00m,
                            WineId = 1
                        },
                        new
                        {
                            ...
                            CustomerId = 2,
                            Quantity = 10,
                            SaleDate = new DateTime(2024, 4, 15, 17, 27, 27, 659, DateTimeKind.Local).AddTicks(3911),
                            SupplierId = 0,
                            TotalPrice = 54.00m,
                            WineId = 2
                        });
            ...
            modelBuilder.Entity("WineCraze.Infrastructure.Data.Models.Sale", b =>
                {
                    ...
                    b.HasOne("WineCraze.Infrastructure.Data.Models.Report", null)
                        .WithMany("Sales")
